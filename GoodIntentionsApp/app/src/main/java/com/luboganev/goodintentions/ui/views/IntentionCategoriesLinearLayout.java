...
public class IntentionCategoriesLinearLayout extends LinearLayout {
	...
	@BindView(R.id.btn_category_search) ImageButton mCategorySearchButton;
	@BindView(R.id.et_new_intent_category) EditText mNewCategoryEditText;
	@BindView(R.id.btn_category_add) ImageButton mCategoryAddButton;
	@BindView(R.id.ll_categories_list) LinearLayout mCategoriesListLinearLayout;
